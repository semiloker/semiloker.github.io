...
const uniforms = {
    ...
    waveColor: { value: new THREE.Vector3(0.5, 0.45, 0.45) },
...
const fragmentShader = `
    ...
    vec3 applyDither(vec2 uvCoord, vec3 color) {
        vec2 scaledCoord = floor(uvCoord * resolution / pixelSize);
...
window.addEventListener('mousemove', (e) => {
    uniforms.mousePos.value.set(
        e.clientX * renderer.getPixelRatio(),
        e.clientY * renderer.getPixelRatio()
    );
});
